...
#ifdef SMALL_ACD 
unsigned char mymac[6] = {0x54,0x55,0x58,0x10,0x00,0x26};
unsigned char myip[4] = {192,168,1,19};
unsigned int myudpport =1202; 
#endif
#ifdef MAX_ACD 
unsigned char mymac[6] = {0x54,0x55,0x58,0x10,0x00,0x25};
unsigned char myip[4] = {192,168,1,18};
unsigned int myudpport =1201; 
#endif
#ifdef MAX_MAIN 
...
/*************************************************
Name:     enc28j60WriteOp     
Function: write the control register   		
Calls: 		SPI1_ReadWrite			 
Called By:enc28j60Write   	 
Input:   
	     op: the one of the seven operations of enc28j60 
       address:the address of the register(we only use its lowly 5 bits) 
...
//set the bank which is the register in
...
{   
    ...
    // This is hex 303F->EPMM0=0x3f,EPMM1=0x30
		...
		//ucen+andor:receive the pack which mac address is match
		//crcen     : give up the packet  which crc is wrong
    ...
    ///*************************
		...
		//loopbk 0: mac loop disable
    //TXPAUS 1: allow the mac send the psuse packet 
    //RXPAUS 1：allow the mac receive  the psuse packet 	
		//MARXEN 1：allow the Mac receive  the data 
    ...
    enc28j60Write(MACON2, 0x00);
		...
		//PADCFG0:2 001: filling the Mac packet which under the 60 bytes 
		//TXCRCEN 1： add tO the CRC after the mac
		//FRMLNEN 1： 
		//FULDPX  1： 
