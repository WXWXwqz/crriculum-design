...
//static unsigned char myip[4] = {192,168,1,17};

/* ip地址(或者是DNS的名字，如果有DNS服务器的话)，ip地址必须以"/"结尾 */
static char baseurl[]="http://192.168.1.17/";
...
unsigned int print_webpage(unsigned char *buf,unsigned char on_off)
{
    ...
    plen=fill_tcp_data_p(buf,plen,PSTR("</center><hr><br><font color=\"#ff0000\"><center>****************^_^ 青岛理工大学 王其朝 毕业设计^_^****************\n"));
